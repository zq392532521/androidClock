...
public class SetAlarm extends PreferenceActivity
    ...
    private DatePickerDialog yeardatePickerDialog  ;
    private int     mId;
    private int     year;
    private int     month;
    private int     day;
    ...
    protected void onCreate(Bundle icicle) {
        ...
        mDatePref = findPreference("takeDate");
    ...
    private void iniTYMDDate(){
    	Calendar nowCalendar=Calendar.getInstance(); 
    	this.year=nowCalendar.get(Calendar.YEAR);
    	this.month=nowCalendar.get(Calendar.MONTH);
    ...
    private void showDateDoalog() {
    	ymdShow();
    }
	public void ymdShow() {
		Calendar nowCalendar=Calendar.getInstance();
		yeardatePickerDialog = new DatePickerDialog(this, this,
				nowCalendar.get(Calendar.YEAR), nowCalendar.get(Calendar.MONTH),
				nowCalendar.get(Calendar.DAY_OF_MONTH));
		// yeardatePickerDialog.setTitle("year-moth");
	...
	public void onDateSet(DatePicker view, int year, int monthOfYear,
		...
		this.day=dayOfMonth;
		mDatePref.setSummary(Alarms.formatYearMonthDay(this,nowCalendar));		
	}
}
