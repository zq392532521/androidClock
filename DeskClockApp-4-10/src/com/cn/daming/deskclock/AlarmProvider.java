    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            String insertMe = "INSERT INTO alarms " +
                    "(hour, minutes, daysofweek, alarmtime, enabled, vibrate, message, alert,year,month,day) " +
                    "VALUES ";
        //    db.execSQL(insertMe + "(8, 30, 31, 0, 0, 1, '', ''"+year+","+month+","+day+");");
        //    db.execSQL(insertMe + "(9, 30, 31, 0, 0, 1, '', ''"+year+","+month+","+day+");");
        }
